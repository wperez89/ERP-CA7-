...
import {
  ...
  cargarOperaciones,
  cargarTipoGarantia,
  cargarTipoPlanInversion,
} from "../interfaces/cargar-credito.interface";
import {
  Operacion,
  OperacionesVista,
  productoCredito,
} from "../models/credito/credito.models";
...
export class CreditoService {
  ...
  cargarOperaciones() {
    ...
    return this.http.get<cargarOperaciones>(url).pipe(
      map((resp) => {
  ...
  cargarGarantias() {
    ...
    return this.http
      ...
      .pipe(
        map(
          (resp: { ok: boolean; Garantia: cargarTipoGarantia[] }) =>
            resp.Garantia
        )
      );
  }
  ...
  cargarLineasCredito() {
    ...
    return this.http
      ...
      .pipe(
        map(
          (resp: { ok: boolean; LineaCred: cargarLineaCreditos[] }) =>
            resp.LineaCred
        )
      );
  }
  ...
  cargarTipoInversion() {
    ...
    return this.http
      ...
      .pipe(
        map(
          (resp: { ok: boolean; planInv: cargarTipoPlanInversion[] }) =>
            resp.planInv
        )
      );
  }
  ...
  cargarProductoCredito() {
    ...
    return this.http
      ...
      .pipe(
        map(
          (resp: { ok: boolean; producto: productoCredito[] }) => resp.producto
        )
      );
  }
  ...
  crearOperacion(credito: Operacion) {
    ...
    return this.http
      ...
      .pipe(
        map(
          (resp: { ok: boolean; operacion: Operacion[]; msg: string }) => resp
        )
      );
  }
  ...
  cargarSolicitudesCredito(id: number) {
    ...
    return this.http
      .get(url)
      .pipe(map((resp: { ok: boolean; solicitud: [] }) => resp.solicitud));
  }
  ...
  cargarEstadosSolicitudCredito() {
    ...
    return this.http
      .get(url)
      .pipe(map((resp: { ok: boolean; estado: [] }) => resp.estado));
  }
  ...
  cargarTrnscSolicCredito(id: string) {
    ...
    return this.http
      .get(url)
      .pipe(map((resp: { ok: boolean; allTransc: [] }) => resp));
  }
  ...
  cargarTrnscSolicCreditoID(id: number) {
    ...
    return this.http
      .get(url)
      .pipe(map((resp: { ok: boolean; allTransc: [] }) => resp.allTransc));
  }
  ...
  crearArchivosSolicitud(formValue: any) {
    const url = `${base_url}/solicitud/transaccion`;
  ...
  crearDocumento(formValue: any, archivos: any[]) {
    const url = `${base_url}/solicitud/documentos`;
    const formData = new FormData();

    formData.append("REF_SOLICITUD", formValue.REF_SOLICITUD);
    formData.append("USUARIO", formValue.USUARIO);
  ...
  obtenerDocumentoSolicitud(id: string) {
    ...
    return this.http
      .get(url)
      .pipe(map((resp: { ok: boolean; documento: [] }) => resp.documento));
  }
}
